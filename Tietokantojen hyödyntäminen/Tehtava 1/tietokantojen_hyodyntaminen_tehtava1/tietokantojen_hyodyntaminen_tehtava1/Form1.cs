...
namespace tietokantojen_hyodyntaminen_tehtava1
{
    ...
    {
        SqlConnection myConnection = new SqlConnection(@"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=Opiskelijat;Integrated Security=True;Connect Timeout=30;Encrypt=False;
    TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
        ...
        private void LisaaTiedotButton_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand myCommand = new SqlCommand("SET IDENTITY_INSERT Nimi ON; INSERT INTO Nimi (Id, Nimet, opintoryhma_Id) " +
        ...
        {
            // TODO: This line of code loads data into the 'opiskelijatDataSet1.opiskelijaryhma' table. You can move, or remove it, as needed.
            this.opiskelijaryhmaTableAdapter.Fill(this.opiskelijatDataSet1.opiskelijaryhma);
            // TODO: This line of code loads data into the 'opiskelijatDataSet.Nimi' table. You can move, or remove it, as needed.
            this.nimiTableAdapter.Fill(this.opiskelijatDataSet.Nimi);
